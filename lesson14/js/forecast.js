const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5604473&appid=e9d5401ed9f7451f4f1190a8ee68704b&units=imperial";
fetch(forecastURL)
    ...
    .then((jsObject) => {
        ...
        jsObject.list.forEach(element => {
            ...
            if (hour == "15") {
                ...
                h3.textContent = element.main.temp + " \u00B0C";
